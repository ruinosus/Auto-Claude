...
import { IPC_CHANNELS, AUTO_BUILD_PATHS, DEFAULT_APP_SETTINGS, DEFAULT_FEATURE_MODELS, DEFAULT_FEATURE_THINKING, THINKING_BUDGET_MAP, getSpecsDir } from '../../../shared/constants';
...
function getUtilitySettings(): { model: string; modelId: string; thinkingLevel: string; thinkingBudget: number | null } {
  ...
  try {
    if (existsSync(settingsPath)) {
      ...
      return {
        model,
        modelId: resolveModelId(model, 'haiku'),
        thinkingLevel,
  ...
  return {
    ...
    modelId: resolveModelId(DEFAULT_FEATURE_MODELS.utility, 'haiku'),
